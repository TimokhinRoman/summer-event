...
<div class="my-3">
    ...
    <p>
        ...
        первобытный трепещущий страх
        я впускаю касанием рук.
    </p>
    <p>
        А еще я даю свет и жизнь,
        помогаю рожденью детей,
        а разгневал меня - так молись
        мои стрелы опаснее змей.
    </p>
    <p>
        Мне свобода природой дана,
        неподвластна я сладкой любви.
        Круг животных я выбрать вольна
...
<div class="my-3">
    ...
    <p>
        ...
        Одариваю женщин любовью неземною,
        но не спешу особо найти свою семью.
    </p>
    <p>
        И мужеством, и силой отмечен я как равный,
        и в смертоносных битвах одерживаю верх
        в копье - моя удача и самый главный навык,
        а стойкость, непреклонность - предвидимый успех.
    </p>
    <p>
        Я Геры сын и Зевса, свирепый воин Арес
        и я пришел увидеть свой праведный триумф,
        что сильный побеждает - исконно и по праву,
...
<div class="my-3">
    ...
    <p>
        ...
        в танце диком сошлось совершенство -
        экзальтации чистая страсть.
    </p>
    <p>
        Я повсюду разлит как явление:
        среди гор и долин, средь лесов
        приводимое в исступление, 
        словно сердце, что чувствует зов.
    </p>
    <p>
        И тебе лучше «слушать» внимательней
        ты вкуси меня и соберись -
        пусть идеи твои занимательны,
